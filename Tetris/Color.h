...
const Color redColor = color(0xFF, 0x00, 0x00, 0xFF);
const Color greenColor = color(0x00, 0xFF, 0x00, 0xFF);
const Color blueColor = color(0x00, 0x00, 0xFF, 0xFF);
const Color yellowColor = color(0xFF, 0xFF, 0x00, 0xFF);
const Color magentaColor = color(0x00, 0xFF, 0xFF, 0xFF);
const Color aquaColor = color(0xFF, 0x00, 0xFF, 0xFF);
